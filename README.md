...
- Na start tworzysz postać (imię i adres startowy) i dostajesz 8-znakowy kod postaci z kodem QR. Żeby wczytać postać, podajesz imię i kod (albo skanujesz QR). Kod można wysłać sobie np. na WhatsAppie (przycisk „Wyślij sobie”) i zobaczyć w grze w menu ☰. Stare postacie (6-znakowy IDIK + hasło) po jednym logowaniu dostają nowy kod.
